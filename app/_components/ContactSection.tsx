...
const INPUT_STYLE =
  "w-full rounded-lg border border-tertiary bg-neutral px-4 py-3 text-primary placeholder:text-primary/45 focus:border-secondary focus:outline-none focus:ring-2 focus:ring-secondary/20";
...
export function ContactSection() {
  ...
  return (
    <section
      id="contact"
      className="relative z-10 border-t border-primary bg-primary py-16 sm:py-20 lg:py-24"
    >
      <Container className="relative">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-16 lg:items-start">
          {/* 왼쪽: Contact 타이틀 + 안내 문구 */}
          <div>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-neutral leading-tight">
              Contact
              <br />
              ADGRIT
            </h2>
            <div className="mt-8 flex items-start gap-3">
              <span className="flex-shrink-0 text-neutral/90 mt-0.5">
              ...
              <div>
                <p className="text-lg font-semibold text-neutral">1-2일 내로 연락드리겠습니다.</p>
                <p className="mt-3 text-sm sm:text-base text-neutral/85 leading-relaxed">
          ...
          >
            ...
            <div className="flex flex-wrap items-center gap-3">
              <label className="flex items-center gap-2 cursor-pointer">
                ...
                />
                <span className="text-sm text-neutral">개인정보 수집 및 이용 동의 CLICK</span>
              </label>
              <a
                href="/privacy"
                className="text-sm text-tertiary/70 hover:text-neutral underline"
              >
                개인정보처리방침
              </a>
            </div>
            ...
            <button
              type="submit"
              className="w-full rounded-lg bg-secondary py-4 text-base font-bold text-primary shadow-lg transition-opacity hover:opacity-95 disabled:opacity-50"
              disabled={!agree}
            >
              작성완료 CLICK
            </button>

            <p className="text-xs text-tertiary/70 text-right">
